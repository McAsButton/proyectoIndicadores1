			...
			<form action="vistaUsuarios.php" method="post">
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu1">Responsables por Indicador</a>
							</li>
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu2">Fuentes por Indicador</a>
							</li>
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu3">Representación visual por Indicador</a>
							</li>
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu3">varoables por Indicador</a>
							</li>																						
						</ul>
						<!-- Tab panes -->
						<div class="tab-content">
							...
							<div class="form-group">
								<label>Id</label>
									<input type="text" id="txtId" name="txtId" class="form-control" value="<?php echo $email ?>">
								</div>
								<div class="form-group">
									<label>Código</label>
									<input type="text" id="txtCodigo" name="txtCodigo" class="form-control" value="<?php echo $contrasena ?>">
								</div>
								<label>Nombre</label>
									<input type="text" id="txtId" name="txtId" class="form-control" value="<?php echo $email ?>">
								</div>
								...
								<!-- Los que son claves foráneas deben ser selects conectadsos a la base de datos -->
								<div class="form-group">
