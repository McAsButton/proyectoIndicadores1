...
<body>
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col"></div>
            <div class="col">
                <form method="post" action="controlUsuario.php" enctype="multipart/formdata">
                    ...
                    <?php if(isset($_POST['action']) && $_POST['action'] == 'new'): ?>
                        ...
                        <button type="button" class="btn btn-success" onclick="window.location.href='VistaUsuario.php';" name="cancelar"><i class="bi bi-x-octagon-fill"></i> Cancelar</button>
