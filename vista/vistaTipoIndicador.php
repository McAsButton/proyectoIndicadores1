                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#addTipoIndicador"><i class="bi bi-person-plus"></i><span>Nuevo Tipo
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <form method="post" action="VistaTipoIndicador.php"
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" name="delete"
                                                    data-bs-toggle="modal" data-bs-target="#deleteTipoIndicador"
...
<main id="main">
    ...
    <!-- Delete Modal HTML -->
    <div class="modal fade" id="deleteTipoIndicador" tabindex="-1" aria-labelledby="deleteTipoIndicador"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
