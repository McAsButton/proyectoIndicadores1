                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addActor"><i class="bi bi-person-plus"></i><span>Nuevo Actor</span></button>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            for($i = $inicio; $i < $fin && $i < $total_registros; $i++){
                              ...
                              $getfkidtipoactor = $arregloActor[$i]->__get('fkidtipoactor');
                            ?>
                            <tr>
                                <td><?= $num_registro ?></td>
                                <td><?= $getid ?></td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm" name="modificar" data-bs-toggle="modal" data-bs-target="#editActor" data-bs-whatever="<?= $getid ?>" data-bs-nombre="<?= $getnombre ?>" data-bs-fkidtipoactor="<?= $getfkidtipoactor ?>"><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                        </form>
                                        <form method="post" action="VistaActor.php" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="VistaActor.php" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">A</span>
                    <input type="text" name='txtFkidTipoActor' id="txtFkidTipoActor" class="form-control" placeholder="FkidActor" aria-label="fkidtipoactor" aria-describedby="basic-addon1">
                </div>
                </div>
...
<script>
    ...
    if (editActor) {
        editActor.addEventListener('show.bs.modal', event => {
            ...
            const FkidActor = button.getAttribute('data-bs-fkidtipoactor')
            ...
            fkidtipoactorInput.value = FkidActor
        })
    }
