                        ...
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    ?>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addUnidadMedicion" disabled><i class="bi bi-person-plus"></i><span>Nueva
                                                Unidad de Medición</span></button>
                                    <?php
                                    }
                                    ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                ?>
                                                    <form method="post" action="VistaUnidadMedicion.php" enctype="multipart/form-data">
                                                        <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
                                                        <button type="button" class="btn btn-warning btn-sm botonModificar" name="modificar" data-bs-toggle="modal" data-bs-target="#editUnidadMedicion" data-bs-whatever="<?= $getid ?>" data-bs-descripcion="<?= $getdescricipcion ?>" disabled><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                                        <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
                                                    </form>
                                                    <form method="post" action="VistaUnidadMedicion.php" enctype="multipart/form-data">
                                                        <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
                                                        <button type="button" class="btn btn-danger btn-sm" name="delete" data-bs-toggle="modal" data-bs-target="#deleteUnidadMedicion" data-bs-id="<?= $getid ?>" disabled><i class="bi bi-trash-fill" style="font-size: 0.75rem;"></i></button>
                                                        <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
                                                    </form>
                                                <?php
                                                }
