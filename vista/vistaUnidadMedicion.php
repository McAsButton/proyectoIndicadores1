                ...
                <div class="table-wrapper">
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="pagination">
                            <?php 
                            // Botón "Anterior"
                            echo "<li class='page-item " . ($pagina_actual == 1 ? 'disabled' : '') . "'><a href='VistaUnidadMedicion.php?nume=" . ($pagina_actual - 1) . "' class='page-link'>Anterior</a></li>";
                            ...
                            // Botón "Siguiente"
                            echo "<li class='page-item " . ($pagina_actual == $total_paginas ? 'disabled' : '') . "'><a href='VistaUnidadMedicion.php?nume=" . ($pagina_actual + 1) . "' class='page-link'>Siguiente</a></li>";
                            ?>
                        </ul>
                    </div>
                </div>
