    ...
    <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <form method="post" action="VistaFuente.php" enctype="multipart/form-data">
                                            <button type="button" class="btn btn-warning btn-sm" name="modificar" data-bs-toggle="modal" data-bs-target="#editFuente" data-bs-whatever="<?= $getid ?>"data-bs-name="<?= $getnombre ?>"><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                        </form>
                                        <form method="post" action="VistaFuente.php" enctype="multipart/form-data">
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Mostrando <b><?= $registros_mostrados ?></b> de <b><?= $total_registros ?></b> fuentes</div>
                        <ul class="pagination">
                            <?php 
                            // Botón "Anterior"
