                ...
                <div class="table-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#addFuente"><i class="bi bi-person-plus"></i><span>Nueva
                                        Fuente</span></button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="btn-group" role="group">
                                            <form method="post" action="VistaFuente.php" enctype="multipart/form-data">
                                                <button type="button" class="btn btn-warning btn-sm botonModificar"
                                                    name="modificar" data-bs-toggle="modal" data-bs-target="#editFuente"
                                            ...
                                            <form method="post" action="VistaFuente.php" enctype="multipart/form-data">
                                                <button type="button" class="btn btn-danger btn-sm" name="delete"
                                                    data-bs-toggle="modal" data-bs-target="#deleteFuente"
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Mostrando <b><?= $registros_mostrados ?></b> de
                            <b><?= $total_registros ?></b> fuentes</div>
                        <ul class="pagination">
                            <?php
                            // Botón "Anterior"
