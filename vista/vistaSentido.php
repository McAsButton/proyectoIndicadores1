                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#addSentido"><i class="bi bi-person-plus"></i><span>Nuevo
                                        Sentido</span></button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="btn-group" role="group">
                                            <form method="post" action="VistaSentido.php" enctype="multipart/form-data">
                                                <button type="button" class="btn btn-warning btn-sm botonModificar"
                                                    name="modificar" data-bs-toggle="modal" data-bs-target="#editSentido"
                                            ...
                                            <form method="post" action="VistaSentido.php" enctype="multipart/form-data">
                                                <button type="button" class="btn btn-danger btn-sm" name="delete"
                                                    data-bs-toggle="modal" data-bs-target="#deleteSentido"
