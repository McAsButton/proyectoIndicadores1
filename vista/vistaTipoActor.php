                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                ...
                                ?>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addTipoActor" disabled><i class="bi bi-person-plus"></i><span>Nuevo Tipo de
                                            Actor</span></button>
                                <?php
                                }
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            ?>
                                                <form method="post" action="VistaTipoActor.php" enctype="multipart/form-data">
                                                    <button type="button" class="btn btn-warning btn-sm botonModificar" name="modificar" data-bs-toggle="modal" data-bs-target="#editTipoActor" data-bs-whatever="<?= $getid ?>" data-bs-name="<?= $getnombre ?>" disabled><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                                </form>
                                                <form method="post" action="VistaTipoActor.php" enctype="multipart/form-data">
                                                    <button type="button" class="btn btn-danger btn-sm" name="delete" data-bs-toggle="modal" data-bs-target="#deleteTipoActor" data-bs-id="<?= $getid ?>" disabled><i class="bi bi-trash-fill" style="font-size: 0.75rem;"></i></button>
                                                </form>
                                            <?php
                                            }
                                            ?>
