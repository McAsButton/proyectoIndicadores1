                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                ...
                                ?>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRepresenVisual"><i class="bi bi-person-plus"></i><span>Nueva
                                            Representacion Visual</span></button>
                                <?php
                                } else {
                                ?>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRepresenVisual" disabled><i class="bi bi-person-plus"></i><span>Nueva
                                            Representacion Visual</span></button>
                                <?php
                                }
                                ?>
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            ?>
                                                <form method="post" action="vistaRepresenVisual.php" enctype="multipart/form-data">
                                                    <button type="button" class="btn btn-warning btn-sm botonModificar" name="modificar" data-bs-toggle="modal" data-bs-target="#editRepresenVisual" data-bs-whatever="<?= $getid ?>" data-bs-name="<?= $getnombre ?>"><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                                </form>
                                                <form method="post" action="vistaRepresenVisual.php" enctype="multipart/form-data">
                                            ...
                                            ?>
                                                <form method="post" action="vistaRepresenVisual.php" enctype="multipart/form-data">
                                                    <button type="button" class="btn btn-warning btn-sm botonModificar" name="modificar" data-bs-toggle="modal" data-bs-target="#editRepresenVisual" data-bs-whatever="<?= $getid ?>" data-bs-name="<?= $getnombre ?>" disabled><i class="bi bi-pencil-square" style="font-size: 0.75rem;"></i></button>
                                                </form>
                                                <form method="post" action="vistaRepresenVisual.php" enctype="multipart/form-data">
                                                    <button type="button" class="btn btn-danger btn-sm" name="delete" data-bs-toggle="modal" data-bs-target="#deleteRepresenVisual" data-bs-id="<?= $getid ?>" disabled><i class="bi bi-trash-fill" style="font-size: 0.75rem;"></i></button>
                                                </form>
                                            <?php
                                            }
                                            ?>
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Mostrando <b><?= $registros_mostrados ?></b> de
                            <b><?= $total_registros ?></b> representaciones visuales
                        </div>
                        <ul class="pagination">
                            <?php
                            // Botón "Anterior"
