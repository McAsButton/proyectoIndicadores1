...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">devCrypt</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Inicio</a></li> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
          <li><a class="nav-link scrollto" href="#about">Acerca de</a></li> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 video-box align-self-baseline" data-aos="zoom-in" data-aos-delay="100">
            ...
            <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox play-btn mb-4"></a> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>devCrypt</h3>
              <p>
                2311 North Los Robles Avenue, Apartment 4A<br>
                Pasadena, California, 91104<br><br>
              ...
              <div class="social-links mt-3">
                ...
                <a href="#" class="google-plus"><i class="bx bxl-skype"></i></a> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
                <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Desarrollo a medida</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Seguridad integral</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Optimización de procesos</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Soporte continuo</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Computación en la nube</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Nuestro Newsletter</h4>
            <p>Mantente al tanto de todo lo relacionado a nuestra compañia</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>devCrypt</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="assets/vendor/purecounter/purecounter_vanilla.js"></script> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
  <script src="assets/vendor/aos/aos.js"></script>
  <script src="assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="assets/vendor/glightbox/js/glightbox.min.js"></script> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
  <script src="assets/vendor/isotope-layout/isotope.pkgd.min.js"></script> <!-- cspell:disable-line <- desabilita el corrector ortografico para esta linea -->
